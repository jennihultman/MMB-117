...
Specify the adapter sequences that you want to trim after `-g` and `-G`. What is the difference with `-g` and `-G`?
...
```
cutadapt -g file:forward.fasta -a file:rc_reverse.fasta -G file:reverse.fasta -A file:rc_forward.fasta -n 2 --max-n 0 --minimum-length 50 A055-5-3-40-80-ACGCTGTC-TGTTTCCT-Heinonsalo-run20201112B_S55_L001_R1_001.fastq.gz A055-5-3-40-80-ACGCTGTC-TGTTTCCT-Heinonsalo-run20201112B_S55_L001_R2_001.fastq.gz -o R1.fastq -p R2.fastq
```
